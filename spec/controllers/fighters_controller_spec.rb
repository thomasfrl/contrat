...
RSpec.describe FightersController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      fighter = Fighter.create! valid_attributes
      get :edit, params: {id: fighter.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the fighter" do
        fighter = Fighter.create! valid_attributes
        put :update, params: {id: fighter.to_param, fighter: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        fighter = Fighter.create! valid_attributes
        put :update, params: {id: fighter.to_param, fighter: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested fighter" do
      fighter = Fighter.create! valid_attributes
      expect {
        delete :destroy, params: {id: fighter.to_param}, session: valid_session
      }.to change(Fighter, :count).by(-1)
    end
