class Fighter < ApplicationRecord
  ...
  validates :attack, presence: true, numericality: {greater_than: 0, less_than: 20}
  validates :life, presence: true, numericality: {greater_than: 0, less_than: 20}
  ...
  def update_xp
    xp = self.xp
    if xp > 0 && xp%3 == 0 #every 3 xp => new level and +1 in life and attack
